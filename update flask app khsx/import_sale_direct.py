#!/usr/bin/env python3
"""
Import Sale THANG 5/2026 trực tiếp vào Neon.tech PostgreSQL
Không cần qua API server - dùng alias map trong sale_importer
"""
import sys, os, time
...
# Set DATABASE_URL truoc khi import config
...
SALE_FILE = os.path.join(DATA_DIR, 'DAILY SALED REPORT THANG 5.2026.xlsm')
MONTH     = 5
YEAR      = 2026
DAY_START = 1
DAY_END   = 17
...
print()
print("=" * 60)
print("  IMPORT SALE THANG 5/2026 TRUC TIEP VAO NEON.TECH")
print(f"  File: {os.path.basename(SALE_FILE)}")
...
if not os.path.exists(SALE_FILE):
    ...
    sys.exit(1)
print(f"[OK] File Excel: {os.path.basename(SALE_FILE)}")
print()
...
print()
print("=" * 60)
print("  KET QUA IMPORT SALE THANG 5/2026 (NGAY 1-17):")
print()
...
print()
print("  Kiem tra tai: https://flask-appkhsx.onrender.com/page/sale")
print("=" * 60)
print()
